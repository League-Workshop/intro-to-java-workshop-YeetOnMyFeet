...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonsHealth > 0) {
			String answer = JOptionPane.showInputDialog("Do you want to attack the dragon with \n a yell or a kick");

			if (answer.equalsIgnoreCase("Yell")) {
				Random rgen = new Random();
				dragonAttack = rgen.nextInt(10);
				dragonsHealth -= dragonAttack;
...
JOptionPane.showMessageDialog(null, "Dragons health = " + dragonsHealth);
